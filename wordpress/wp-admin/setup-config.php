...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td><input name="uname" id="uname" type="text" size="25" value="<?php echo htmlspecialchars( _x( 'wordpress', 'example username' ), ENT_QUOTES ); ?>" /></td>
			<td><?php _e( 'Your database username.' ); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="pwd"><?php _e( 'Password' ); ?></label></th>
			<td><input name="pwd" id="pwd" type="text" size="25" value="<?php echo htmlspecialchars( _x( 'wordpress', 'example password' ), ENT_QUOTES ); ?>" autocomplete="off" /></td>
