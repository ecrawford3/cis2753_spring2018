...
<?php
	...
	$staff_directory_position = $custom["staff_directory_position"][0];
...
<legend>Staff Directory Fields</legend>
	...
	<label class="staff-directory-label">Position: </label>
	<input class="staff_directory-input" name="staff_directory_position" type="text" value="<?php echo $staff_directory_position; ?>" required />
	</fieldset>